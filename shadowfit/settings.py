...
SECRET_KEY = 'django-insecure-yxwzho(%b7+!@5np(v%($h8u@lf5n7&i_oqeyz*5f_i&o9lp%h'
...
ROOT_URLCONF = 'shadowfit.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        #Permite que django encuentre las pantallas de login personalizadas
...
WSGI_APPLICATION = 'shadowfit.wsgi.application'
